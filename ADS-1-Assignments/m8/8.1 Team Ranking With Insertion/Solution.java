...
class Team {
    ...
    private int wins;
    /**
     * the variable to store number of lost matches.
     */
    private int losses;
    /**
     * the variable to store number of tie matches.
     */
    private int tie;
    /**
...
/**
 * Class for leader board ,it stores the data of all teams.
 */
class LeaderBoard {
    /**
    * list is the arraylist created for storing all the objects.
     */
    private ArrayList<Team> list;
    /**
     * the constructor to initialize the arraylist.
     */
    LeaderBoard() {
        list = new ArrayList<Team>();
    }
    /**
     *the compareto method is to check the number of wins and losses.
     * @param      teamOne   One
     * @param      teamTwo   Two
    ...
    /**
     * the method to add the object to array the time complexity is O(1)
    ...
    /**
     *this method is to perform the sorting operation.
     *the time complexiety will be N^2.
     *N is the size of array.
     *it will iterate through out the array.
     *for each comparision  we have N comparisons.
     */
    public void sorting() {
        int max = 0;
        int flag = 0;
